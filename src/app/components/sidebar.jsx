                ...
                <div className="topPart flex-auto">
                    <div className="flex flex-row">
                        ...
                        <div className={`${expanded ? "flex justify-end mb-6 ml-10 py-1 translate-x-12 overlay" : "flex justify-end py-1 translate-x-8"}`}>
                            <button className="fixed p-1 rounded-full bg-textHover" onClick={() => setExpanded(!expanded)}><IoChevronBackOutline className="text-white" fontSize={18} /></button>
                        </div>
                    </div>
                    ...
                    <div className="mb-32">
                        {
                            DASHBOARD_SIDEBAR_LINKS.map((element) => {
                                ...
                                return (
                                    <>
                                        <Link key={element.key} href={element.path} >
                                            <div className={`py-2 text-textColor2 hover:bg-textHover ${isActive ? "text-textColor1" : ""} hover:text-textColor1 px-2`}>
